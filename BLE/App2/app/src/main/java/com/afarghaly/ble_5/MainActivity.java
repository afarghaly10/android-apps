...
public class MainActivity extends AppCompatActivity implements BeaconConsumer{
    ...
    public void exportData(String filename) throws IOException{
        TextView editText = (TextView) MainActivity.this.findViewById(R.id.timeStamp);
    ...
    private void logToDisplay(final String Timestamp,final String Address, final String RSSI, final String Mark) {
        runOnUiThread(new Runnable() {
            public void run() {
                final TextView editTimestamp = (TextView) MainActivity.this.findViewById(R.id.timeStamp);
                TextView editAddress = (TextView) MainActivity.this.findViewById(R.id.address);
                TextView editRSSI = (TextView) MainActivity.this.findViewById(R.id.rssi);
                TextView editMark = (TextView) MainActivity.this.findViewById(R.id.mark);
    ...
    private void clearView(){
        TextView editTimestamp = (TextView) MainActivity.this.findViewById(R.id.timeStamp);
        TextView editAddress = (TextView) MainActivity.this.findViewById(R.id.address);
        TextView editRSSI = (TextView) MainActivity.this.findViewById(R.id.rssi);
        TextView editMark = (TextView) MainActivity.this.findViewById(R.id.mark);
...
This signifies that the beacon type will be decoded when an advertisement is found with 0xbeac in bytes 2-3,
and a three-part identifier will be pulled out of bytes 4-19, bytes 20-21 and bytes 22-23, respectively.
A signed power calibration value will be pulled out of byte 24, and a data field will be pulled out of byte 25.
 */

/*
-8-ALTBEACON      m:2-3=beac,i:4-19,i:20-21,i:22-23,p:24-24,d:25-25
-9-EDDYSTONE TLM  x,s:0-1=feaa,m:2-2=20,d:3-3,d:4-5,d:6-7,d:8-11,d:12-15
-7-EDDYSTONE UID  s:0-1=feaa,m:2-2=00,p:3-3:-41,i:4-13,i:14-19
-10-EDDYSTONE URL  s:0-1=feaa,m:2-2=10,p:3-3:-41,i:4-20v
-5-IBEACON        m:2-3=0215,i:4-19,i:20-21,i:22-23,p:24-24
 */
